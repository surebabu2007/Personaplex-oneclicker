        ...
        <table>
          <tbody>
            <tr>
              ...
              <td className="p-2"><input className="ppx-field" disabled={isConnected} type="text" id="text-prompt" name="text-prompt" value={modalTextPrompt} onChange={e => setModalTextPrompt(e.target.value)} /></td>
            </tr>
            <tr>
              <td>Voice Prompt:</td>
              <td className="w-12 text-center">{modalVoicePrompt}</td>
              <td className="p-2">
                <select className="ppx-field" disabled={isConnected} id="voice-prompt" name="voice-prompt" value={modalVoicePrompt} onChange={e => setModalVoicePrompt(e.target.value)}>
